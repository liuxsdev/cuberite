	...
	a_ChunkDesc:SetHeight(0, 0, Height + 1);
		...
		cCompositeChat =
		{
			Desc = [[
				...
				<img src="http://static.wikia.nocookie.net/minecraft_gamepedia/images/4/4c/Colors.png" />
			]],
			Functions =
			{
				AddRunCommandPart =
	...
	-- Next time the player presses Statistics they will see the updated value for furnace interactions.
		...
		CustomStatistic =
		{
			...
			Constants =
			{
				...
				AviateOneCm =
				{
					Notes = "The total distance traveled by elytra.",
				},
				BellRing =
				{
				...
				BoatOneCm =
				{
					Notes = "The total distance traveled by boats.",
				},
				CleanArmor =
				{
				...
				ClimbOneCm =
				{
					Notes = "The total distance traveled up ladders or vines.",
				},
				CrouchOneCm =
				{
				...
				DamageDealtAbsorbed =
				{
					Notes = "The amount of damage the player has dealt that were absorbed, in tenths of 1.",
				},
				DamageDealtResisted =
				{
					Notes = "The amount of damage the player has dealt that were resisted, in tenths of 1.",
				},
				DamageResisted =
				{
				...
				HorseOneCm =
				{
					Notes = "The total distance traveled by horses.",
				},
				InspectDispenser =
				{
				...
				JunkFished =
				{
					Notes = "The number of junk fished.",
				},
				Jump =
				{
				...
				MinecartOneCm =
				{
					Notes = "The total distance traveled by minecarts.",
				},
				MobKills =
				{
				...
				PigOneCm =
				{
					Notes = "The total distance traveled by pigs via saddles.",
				},
				PlayNoteblock =
				{
				...
				StriderOneCm =
				{
					Notes = "The total distance traveled by striders via saddles.",
				},
				SwimOneCm =
				{
